...
// Moved to @lib/generate-sku (shared by every vendor create-flow that mints
// a SKU on the seller's behalf) — re-exported here so existing imports of
// `getSellerSkuCode`/`generateVariantSku` from this module keep working.
export { getSellerSkuCode, generateVariantSku } from "@lib/generate-sku"
