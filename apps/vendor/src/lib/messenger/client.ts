...
// Keys off the panel's active language on every call — mirrors the
// backend client (apps/vendor/src/lib/client.ts) so messenger error
// responses (see messenger/src/lib/error-i18n) come back translated too.
